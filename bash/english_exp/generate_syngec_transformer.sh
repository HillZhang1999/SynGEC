...
MODEL_DIR=../../model/english_transformer_syngec/$SEED/stage3
...
cp $CoNLL14_INPUT_FILE".bpe" $OUTPUT_DIR/CoNLL14.src".bpe"
cp $BEA19_INPUT_FILE".bpe" $OUTPUT_DIR/BEA19.src".bpe"
