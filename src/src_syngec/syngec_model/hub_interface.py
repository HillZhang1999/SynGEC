...
class BARTHubInterface(nn.Module):
    ...
    def _build_sample(self, src_tokens: List[torch.LongTensor], src_conll_dataset=None, src_dpd_dataset=None, src_probs_dataset=None,):
    ...
    def sample(
        self, sentences: List[str], beam: int = 1, verbose: bool = False, src_conll_dataset=None, src_dpd_dataset=None, src_probs_dataset=None, **kwargs
    ) -> str:
        input = [self.encode(sentence) for sentence in sentences]
        hypos = self.generate(input,src_conll_dataset, src_dpd_dataset, src_probs_dataset, beam, verbose, **kwargs)
    ...
    def generate(
        ...
        **kwargs
        ...
        sample = self._build_sample(tokens, src_conll_dataset, src_dpd_dataset, src_probs_dataset)
